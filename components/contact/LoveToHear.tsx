...
const LoveToHear = () => {
  return (
    <div className="container text-center lg:px-[112px] px-[33px]">
      ...
      <h2 className="text-xl text-font-01 font-bold my-[10px]">We’d love to hear from you</h2>
      <p className="text-base text-font-02">Our friendly team is always here to chat.</p>
        ...
        {contacts.map((contact, index) => (
          <div key={index} className="flex flex-col">
            ...
            <div className="details">
              ...
              <p className="text-font-02 text-sm mb-[10px] mt-[5px]">{contact.content}</p>
              <p className="font-semibold text-primary text-sm ">{contact.info}</p>
            </div>
          </div>
        ))}
      </div>
