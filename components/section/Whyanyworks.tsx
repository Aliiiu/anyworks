...
const reasons: reasonType[] = [
  {
    title: (
      <>
        GET CONNECTED TO <b className="text-primary text-lg">TRUSTED</b> ARTISANS{' '}
      </>
    ),
  ...
  },
  {
    title: (
      <>
        <b className="text-primary text-lg">SECURED</b> PAYMENT METHOD
      </>
    ),
  ...
  },
  {
    title: (
      <>
        {' '}
        💯 <b className="text-primary text-lg">RELIABLE</b> ARTISANS
      </>
    ),
    content:
  ...
  },
  {
    title: (
      <>
        <b className="text-primary text-lg">TRANSPARENT</b> WORK-FLOW.{' '}
      </>
    ),
        ...
        {reasons.map((item, idx) => (
          <div key={idx} className="flex mb-[20px] md:mb-[30px]">
            ...
            <div className="">
              ...
              <p className="text-[#475467] text-[16px] w-[100%]">{item.content}</p>
            </div>
          </div>
        ))}
      </div>
