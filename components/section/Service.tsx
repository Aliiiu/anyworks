...
const ServiceSection = () => {
	return (
		<div className='container px-[33px] lg:px-[112px]'>
			<h1 className='text-[#00CCCD] font-bold lg:leading-[55px]'>
			...
			<div className='bg-[#00CCCD] grid grid-rows-4 gap-y-[20px] md:grid-cols-2 md:grid-rows-1 lg:grid-cols-4 md:gap-x-[20px] rounded-[30px] p-[15px] w-full'>
				...
				<div className='w-full relative overflow-hidden serviceTwo h-[230px] bg-center serviceStyle'>
					<Link href={'/services'}>
						<a>
							<div className='flex justify-center items-center absolute bottom-0 w-full text-white serviceTag h-[70px]'>
								Plumber
				...
				<div className='overflow-hidden relative serviceThree h-[230px] bg-center serviceStyle'>
					<Link href={'/services'}>
						<a>
							<div className='flex justify-center items-center absolute bottom-0 w-full text-white serviceTag h-[70px]'>
								Hair Stylist
