...
const Contactus = () => {
  return (
    <div>
      <Head>
        <title>Anyworks | Contact Us</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="shortcut icon" href="svgs/logo.svg" />
      </Head>
      <div className="container relative">
        <div className="absolute hidden lg:block left-0 top-[50px]">
          <Image src="/images/circle.png" alt="circle point" width={'110px'} height={'180px'} />
        </div>
        <div className="absolute bottom-[300px] hidden lg:block right-0">
          <Image src="/images/circle2.png" alt="circle point" width={'110px'} height={'180px'} />
        </div>
        <div className="lg:mt-[170px] mt-[145px] mb-[52px] xl:mb-[213px] px-[33px] xl:px-[234px]">
