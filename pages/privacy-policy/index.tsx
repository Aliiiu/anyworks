			...
			<div className='container relative'>
				...
				<div className='xl:mt-[144px] mt-[112px] mb-[65px] lg:mb-[100px] px-[33px] lg:px-[234px]'>
					...
					<p>
						...
						applies only to the actions of ANYWORKS and Users with respect to
						...
						applicable Data Protection Laws, ANYWORKS is the &apos;data
						controller&apos;. This means that ANYWORKS determines the purposes
					...
					<p className='mb-[15px] xl:mb-[25px]'>
						{' '}
						<span className='font-bold mr-3'>7.</span> ANYWORKS will collect
					...
					<p className='mb-[15px] xl:mb-[25px]'>
						{' '}
						<span className='font-bold mr-3'>8.</span> ANYWORKS will receive
					...
					<p className='mb-[15px] xl:mb-[25px]'>
						...
						issues; <br /> b. third party service providers who provide services
					...
					<p className='mb-[15px] xl:mb-[25px]'>
						...
						user name that is unique to you. <br /> b. we store your Data on
					...
					<p className='mb-[15px] xl:mb-[25px]'>
						{' '}
						<span className='font-bold mr-3'>26.</span> ANYWORKS may, from time
						to time, expand or reduce our business and this may involve the sale
						and/or the transfer of control of all or part of ANYWORKS. Data
					...
					<p className='mb-[15px] xl:mb-[25px]'>
						...
						and access certain Cookies on your computer. ANYWORKS uses Cookies
						to improve your experience of using the Website and to improve our
						range of services. ANYWORKS has carefully chosen these Cookies and
						...
						your consent to the placing of Cookies, you are enabling ANYWORKS to
					...
					<p className='mb-[15px] xl:mb-[25px]'>
						{' '}
						<span className='font-bold mr-3'>42.</span> ANYWORKS reserves the
					...
					<h4>
						You may contact ANYWORKS by email at{' '}
